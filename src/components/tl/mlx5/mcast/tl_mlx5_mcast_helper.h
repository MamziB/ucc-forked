...
/* this function returns the number of signaled sends that
 * have been completed or -1 in case of error */
 ...
 * have been arrived or -1 in case of error */
...
/* this function returns the number of mcast recv packets
 * that have been completed  or -1 in case of error */
